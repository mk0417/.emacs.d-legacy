...
(with-eval-after-load 'evil
  (define-key evil-normal-state-map (kbd ",on") 'toki-smooth-scroll-half-page-up)
  (define-key evil-normal-state-map (kbd ",op") 'toki-smooth-scroll-half-page-down)
  (define-key evil-normal-state-map (kbd ",oa") 'toki-beginning-of-line)
  (define-key evil-normal-state-map (kbd ",oe") 'toki-end-of-line)
  (define-key evil-normal-state-map (kbd ",ow") 'toki-forward-subsentence)
  (define-key evil-normal-state-map (kbd ",ob") 'toki-backward-subsentence)
  (define-key evil-normal-state-map (kbd ",ol") 'toki-forward-delete-word)
  (define-key evil-normal-state-map (kbd ",oh") 'toki-backward-delete-word)
  (define-key evil-normal-state-map (kbd ",oc") 'puni-kill-line)
  (define-key evil-normal-state-map (kbd ",oi") 'p-puni-kill-line-and-insert)
  (define-key evil-normal-state-map (kbd ",ok") 'puni-beginning-of-sexp)
  (define-key evil-normal-state-map (kbd ",oj") 'puni-end-of-sexp)
  (define-key evil-normal-state-map (kbd ",oo") 'puni-expand-region)
  (define-key evil-normal-state-map (kbd ",od") 'puni-syntactic-forward-punct)
  (define-key evil-normal-state-map (kbd ",os") 'puni-syntactic-backward-punct)
  (define-key evil-normal-state-map (kbd ",ou") 'puni-forward-sexp)
  (define-key evil-normal-state-map (kbd ",ot") 'puni-backward-sexp)
  (define-key evil-normal-state-map (kbd ",og") 'toki-shrink-whitespace)
  (define-key evil-normal-state-map (kbd ",o.") 'puni-mark-sexp-at-point)
  (define-key evil-normal-state-map (kbd ",o,") 'puni-mark-sexp-around-point)
  (define-key evil-normal-state-map (kbd ",o;") 'puni-mark-list-around-point)

  (define-key evil-visual-state-map (kbd ",oo") 'puni-expand-region)
  (define-key evil-visual-state-map (kbd ",ou") 'puni-forward-sexp)
  (define-key evil-visual-state-map (kbd ",ot") 'puni-backward-sexp)
