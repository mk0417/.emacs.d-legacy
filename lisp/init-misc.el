...
(with-eval-after-load 'evil
  ...
  (define-key evil-normal-state-map (kbd "god") 'sp-splice-sexp)
  (define-key evil-normal-state-map (kbd "gok") 'p-add-paren)
  (define-key evil-normal-state-map (kbd "gof") 'p-add-bracket)
  (define-key evil-normal-state-map (kbd "goh") 'p-add-curly)
  ...
  (define-key evil-visual-state-map (kbd "gok") 'p-add-paren)
  (define-key evil-visual-state-map (kbd "gof") 'p-add-bracket)
  (define-key evil-visual-state-map (kbd "goh") 'p-add-curly)
  ...
  (p-comma-leader-def
    ...
    "r"   '(:ignore t :which-key "search and replace")
